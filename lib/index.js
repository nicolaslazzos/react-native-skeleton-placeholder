...
const SkeletonContainer = (props) => {
    ...
    const SCREEN_HEIGHT = react_native_1.useWindowDimensions().height;
    ...
    return (<exports.SkeletonContext.Provider value={context}>
      <react_native_1.View onLayout={onLayout}>
        {(layout === null || layout === void 0 ? void 0 : layout.width) && (layout === null || layout === void 0 ? void 0 : layout.height) ? (<masked_view_1.default style={{ maxHeight: SCREEN_HEIGHT, height: layout.height, width: layout.width }} maskElement={<react_native_1.View>{children}</react_native_1.View>}>
